...
const Review = () => {
    ...
    return (
        <div className='my-20 w-4/5 mx-auto'>
            <div>
                <p className='text-base text-center'>--What our client say--</p>
                <div className='border-t-2 border-b-2 border-gray-300 py-5 w-60 mx-auto text-center'>
                    <h1 className='uppercase text-2xl'>Testimonials</h1>
                </div>
            </div>
            <div>
                <Swiper
                ...
                >
                    {
                        review.map(rev => <SwiperSlide key={rev._id}>
                            <div className='flex flex-col justify-center items-center space-y-10 px-40 py-5'>
                                <Rating
                                    style={{ maxWidth: 180 }}
                                    value={rev.rating}
                                    readOnly
